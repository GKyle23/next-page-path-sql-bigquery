#legacySQL
-- Funnel analysis for registration forms (written ~2016, preserved as-is)
-- This query uses BigQuery Legacy SQL syntax against the GA Universal Analytics schema. See /docs/ for notes.
